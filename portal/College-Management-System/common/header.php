...
<html>
<head>
	<title>Gachanu Training Institute</title>
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="../../../assets/images/newimages/logo/logo_61.png" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">Gachanu Training Institute</h3>
	</a>
